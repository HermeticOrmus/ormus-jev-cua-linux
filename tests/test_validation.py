...
from ormus_jev_cua import ActionKind, Decision, DesktopElement, DesktopSnapshot, Subtask
from ormus_jev_cua.errors import InvalidDecision
from ormus_jev_cua.validation import materialize_action
from ormus_jev_cua.backends.linux_ocr import LinuxOcrProvider
...
def test_ocr_stub_raises() -> None:
    with pytest.raises(NotImplementedError):
        LinuxOcrProvider().capture_elements()
    assert LinuxOcrProvider().observe_empty() == ()
